...
- 3: Buggy AST optimization and normalization (other)
- 4: Incomplete or incorrect query plan space -- wrong interpretation of clause semantic
- 5: Incomplete or incorrect query plan space --  wrong interpretation of plan operator semantic
